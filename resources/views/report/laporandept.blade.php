...
<div class="container-xl">
    <div class="row g-2 align-item-center">
      <div class="col">
        <h2 class="page-title">Report presensi Departemen</h2>
      </div>
    </div>
   </div>
</div>
    ...
    <div class="container-xl">
        <div class="row">
            <div class="col-6">
                <div class="card">
                    <div class="card-body">
                        <form action="/report/cetaklaporandept" target="_blank" method="POST">
                            @csrf
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        @foreach ($departemen as $k)
                                            <option value="{{$k ->dept_kode}}"> {{$k->nama_dept}}</option>
                                        @endforeach
                                    </select>
                                    </div>
                                </div>
